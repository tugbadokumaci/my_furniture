...
class LoginView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return BlocProvider<LoginCubit>(
      create: (context) => LoginCubit(
        ...
        emailController,
        passwordController,
        service: LoginService(Dio(BaseOptions(baseUrl: ApplicationConstants.BASE_URL))),
      ),
  ...
  AutovalidateMode autovalidateMode(LoginState state) => state is LoginValidateState
